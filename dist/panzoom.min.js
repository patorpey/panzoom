...
/**
   ...
   *
   */
const q={animate:!1,canvas:!1,cursor:"move",disablePan:!1,disableZoom:!1,disableXAxis:!1,disableYAxis:!1,duration:200,easing:"ease-in-out",exclude:[],excludeClass:"panzoom-exclude",handleStartEvent:t=>{t.preventDefault(),t.stopPropagation()},maxScale:4,minScale:.125,overflow:"hidden",panOnlyWhenZoomed:!1,relative:!1,setTransform:function(t,{x:e,y:n,scale:o,isSVG:r},a){T(t,"transform",`scale(${o}) translate(${e}px, ${n}px)`),r&&(r=window.getComputedStyle(t).getPropertyValue("transform"),t.setAttribute("transform",r))},startX:0,startY:0,startScale:1,step:.3,touchAction:"none"};function t(r,i){if(!r)throw new Error("Panzoom requires an element as an argument");if(1!==r.nodeType)throw new Error("Panzoom requires an element with a nodeType of 1");if(!function(t){const e=t.ownerDocument;return t=t.parentNode,e&&t&&9===e.nodeType&&1===t.nodeType&&e.documentElement.contains(t)}(r))throw new Error("Panzoom should be called on elements that have been attached to the DOM");i={...q,...i};const s=(t=r,W.test(t.namespaceURI)&&"svg"!==t.nodeName.toLowerCase());var t;const n=r.parentNode;n.style.overflow=i.overflow,n.style.userSelect="none",n.style.touchAction=i.touchAction,(i.canvas?n:r).style.cursor=i.cursor,r.style.userSelect="none",r.style.touchAction=i.touchAction,r.style.willChange="transform",T(r,"transformOrigin","string"==typeof i.origin?i.origin:s?"0 0":"50% 50%");let l=0,c=0,p=1,o=!1,a=!1,d=C(r);function u(t,e,n){n.silent||(e=new CustomEvent(t,{detail:e}),r.dispatchEvent(e))}function h(t,e,n){const o={x:l,y:c,scale:p,isSVG:s,originalEvent:n};return requestAnimationFrame(()=>{"boolean"==typeof e.animate&&(e.animate&&!a?(a=!0,T(r,"transition",`transform ${e.duration}ms ${e.easing}`)):!e.animate&&a&&(a=!1,T(r,"transition","none"))),e.setTransform(r,o,e)}),u(t,o,e),u("panzoomchange",o,e),o}function m(){var t,e;i.contain&&(d=C(r),t=d.parent.width-d.parent.border.left-d.parent.border.right,e=d.parent.height-d.parent.border.top-d.parent.border.bottom,t=t/d.elem.width,e=e/d.elem.height,"inside"===i.contain?i.maxScale=Math.min(t,e):"outside"===i.contain&&(i.minScale=Math.max(t,e)))}function f(t,e,n,o){var r={...i,...o};const a={x:l,y:c,opts:r};return!r.force&&(r.disablePan||r.panOnlyWhenZoomed&&p===r.startScale)||(t=parseFloat(t),e=parseFloat(e),r.disableXAxis||(a.x=(r.relative?l:0)+t),r.disableYAxis||(a.y=(r.relative?c:0)+e),"inside"===r.contain?(a.x=Math.max(-d.elem.margin.left-d.parent.padding.left,Math.min(d.parent.width-d.elem.width-d.parent.padding.left-d.elem.margin.left-d.parent.border.left-d.parent.border.right,a.x)),a.y=Math.max(-d.elem.margin.top-d.parent.padding.top,Math.min(d.parent.height-d.elem.height-d.parent.padding.top-d.elem.margin.top-d.parent.border.top-d.parent.border.bottom,a.y))):"outside"===r.contain&&(e=((t=(o=d.elem.width)*n)-o)/2,r=((o=(r=d.elem.height)*n)-r)/2,t=(-(t-d.parent.width)-d.parent.padding.left-d.parent.border.left-d.parent.border.right+e)/n,e=(e-d.parent.padding.left)/n,a.x=Math.max(Math.min(a.x,e),t),o=(-(o-d.parent.height)-d.parent.padding.top-d.parent.border.top-d.parent.border.bottom+r)/n,n=(r-d.parent.padding.top)/n,a.y=Math.max(Math.min(a.y,n),o))),a}function g(t,e){e={...i,...e};const n={scale:p,opts:e};return!e.force&&e.disableZoom||(n.scale=Math.min(Math.max(t,e.minScale),e.maxScale)),n}function y(t,e,n,o){e=f(t,e,p,n),n=e.opts;return l=e.x,c=e.y,h("panzoompan",n,o)}function v(n,o,r){var a=g(n,o),o=a.opts;if(o.force||!o.disableZoom){n=a.scale;let t=l,e=c;o.point?(t=o.point.x,e=o.point.y):o.focal&&(i=o.focal,t=(i.x/n-i.x/p+l*n)/n,e=(i.y/n-i.y/p+c*n)/n);var i=f(t,e,n,{relative:!1,force:!0});return l=i.x,c=i.y,p=n,h("panzoomzoom",o,r)}}function e(t,e){e={...i,animate:!0,...e};return v(p*Math.exp((t?1:-1)*e.step),e)}function w(t,e,n,o){var r={width:d.parent.width-d.parent.padding.left-d.parent.padding.right-d.parent.border.left-d.parent.border.right,height:d.parent.height-d.parent.padding.top-d.parent.padding.bottom-d.parent.border.top-d.parent.border.bottom};let a=e.clientX-d.parent.left-d.parent.padding.left-d.parent.border.left-d.elem.margin.left,i=e.clientY-d.parent.top-d.parent.padding.top-d.parent.border.top-d.elem.margin.top;s||(a-=d.elem.width/2,i-=d.elem.height/2);r={x:a/r.width*(r.width*t),y:i/r.height*(r.height*t)};return v(t,{animate:!1,...n,focal:r},o)}v(i.startScale,{animate:!1}),setTimeout(()=>{m(),y(i.startX,i.startY,{animate:!1})});let b,x,S,P,A,E;const O=[];function z(t){!function(e,n){for(let t=e;null!=t;t=t.parentNode)if(o=t,r=n.excludeClass,1===o.nodeType&&o.classList.contains(r)||n.exclude.includes(t))return 1;var o,r}(t.target,i)&&(I(O,t),o=!0,i.handleStartEvent(t),b=l,x=c,d=C(r),u("panzoomstart",{x:l,y:c,scale:p,isSVG:s,originalEvent:t},i),t=L(O),S=t.clientX,P=t.clientY,A=p,E=Z(O))}function M(t){var e;o&&void 0!==b&&void 0!==x&&void 0!==S&&void 0!==P&&(I(O,t),e=L(O),1<O.length?(0===E&&(E=Z(O)),w(g((Z(O)-E)*i.step/80+A).scale,e)):y(b+(e.clientX-S)/p,x+(e.clientY-P)/p,{animate:!1},t))}function X(t){1===O.length&&u("panzoomend",{x:l,y:c,scale:p,isSVG:s,originalEvent:t},i),function(t,e){if(e.touches)for(;t.length;)t.pop();else{e=B(t,e);-1<e&&t.splice(e,1)}}(O,t),o&&(o=!1,b=x=S=P=void 0)}let Y=!1;function $(){Y||(Y=!0,N("down",i.canvas?n:r,z),N("move",document,M,{passive:!0}),N("up",document,X,{passive:!0}))}return i.noBind||$(),{bind:$,destroy:function(){Y=!1,V("down",i.canvas?n:r,z),V("move",document,M),V("up",document,X)},eventNames:G,getPan:()=>({x:l,y:c}),getScale:()=>p,getOptions:()=>function(t){const e={};for(const n in t)t.hasOwnProperty(n)&&(e[n]=t[n]);return e}(i),pan:y,reset:function(t){var e={...i,animate:!0,force:!0,...t};return p=g(e.startScale,e).scale,t=f(e.startX,e.startY,p,e),l=t.x,c=t.y,h("panzoomreset",e)},resetStyle:function(){n.style.overflow="",n.style.userSelect="",n.style.touchAction="",n.style.cursor="",r.style.cursor="",r.style.userSelect="",r.style.touchAction="",T(r,"transformOrigin","")},setOptions:function(t={}){for(const e in t)t.hasOwnProperty(e)&&(i[e]=t[e]);(t.hasOwnProperty("cursor")||t.hasOwnProperty("canvas"))&&(n.style.cursor=r.style.cursor="",(i.canvas?n:r).style.cursor=i.cursor),t.hasOwnProperty("overflow")&&(n.style.overflow=t.overflow),t.hasOwnProperty("touchAction")&&(n.style.touchAction=t.touchAction,r.style.touchAction=t.touchAction),(t.hasOwnProperty("minScale")||t.hasOwnProperty("maxScale")||t.hasOwnProperty("contain"))&&m()},setStyle:(t,e)=>T(r,t,e),zoom:v,zoomIn:function(t){return e(!0,t)},zoomOut:function(t){return e(!1,t)},zoomToPoint:w,zoomWithWheel:function(t,e){t.preventDefault();var n={...i,...e},e=(0===t.deltaY&&t.deltaX?t.deltaX:t.deltaY)<0?1:-1;return w(g(p*Math.exp(e*n.step/3),n).scale,t,n)}}}return t.defaultOptions=q,t});